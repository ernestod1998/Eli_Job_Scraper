...
class ChokePoint(unittest.TestCase):
    ...
    def test_choke_point_clamps_a_future_dated_job(self):
        ...
        out = self.save([{
            "company": "Acme", "title": "Financial Analyst", "location": "Sacramento, CA",
    ...
    def test_no_written_job_is_ever_future_dated(self):
        today = sj.local_today().strftime("%Y-%m-%d")
        jobs = [
            {"company": "A", "title": "Financial Analyst", "url": "https://example.com/1",
             "date_posted": "2027-01-01", "location": "Sacramento, CA", "ats": "LinkedIn"},
            {"company": "B", "title": "Financial Analyst", "url": "https://example.com/2",
             "date_posted": "2026-07-01", "location": "Sacramento, CA", "ats": "Indeed"},
            {"company": "C", "title": "Financial Analyst", "url": "https://example.com/3",
             "date_posted": "Posted Today", "location": "Sacramento, CA", "ats": "Workday"},
        ]
